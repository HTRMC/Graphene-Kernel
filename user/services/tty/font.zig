// Simple 8x8 bitmap font (ASCII 32-126). Mirrors src/lib/font.zig — the
// tty service owns the glyph rendering now, so the asset lives in user
// space alongside the renderer.
